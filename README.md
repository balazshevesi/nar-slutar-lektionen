...
- [x] Lägg till flera komuner? (behöver lägga till nån typ av sök funktion isåfall) (det ser ju ut som att VARENDA komun i sverige har skola24 scheman, så det blir nog bara att kötta in en fet lista med de)
- [ ] Kötta upp reklamer dock??? lär endå bli lite pengar
- [x] Göra "schoolYear" värdet dynamiskt, (det ändras varje skol år)
